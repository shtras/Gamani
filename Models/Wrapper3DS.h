...
{
public:
  static inline Wrapper3DS& getInstance()
  {
    static Wrapper3DS instance;
    return instance;
  }

  Model* Load(CString fileName); // Loads a model
private:
  Wrapper3DS();
  ~Wrapper3DS();
  static Wrapper3DS* instance_;
  ...
  Material3DS *Materials; // The array of materials
